...
<meta name="Author" content="king Bot Team"/>
<meta name="description" content="Official all Facebook friend requests accepter tool by which you can accept all Facebook friend requests in a single click 2017."/>
<meta name="keywords" content="friend request accepter tool, accept all friend requests at once, accept all requests in a single click, facebook requests accepter at once,"/>
...
<meta content="width=device-width, initial-scale=1, maximum-scale=1" name="viewport">
	...
	<link rel="icon" type="image/x-icon" href="http://blogs-images.forbes.com/parmyolson/files/2012/08/anonymous_logo.png"> <title>Friend Requests Accepter Tool </title>
...
<br>
<center>
<h2 <font size="26" color="sky blue"><center></font><font face="Orbitron" size="6" style="background: url(&quot;http://i106.photobucket.com/albums/m280/YukioKenshin/chopnhay.gif&quot;) repeat scroll 0% 0% transparent; color:#fff; text-shadow: 0pt 0pt 0.6em gold, 0pt 2pt 0.6em white;"><b>  Auto Friend Request Acceptor Tool  </b></font><font size="26" color="sky blue"> </center></font>
</h2>
<br>
<center><a target="_blank"  href="https://www.facebook.com/itxx.abdul"><img src="https://mir-s3-cdn-cf.behance.net/projects/404/9dc19532493093.Y3JvcCw4NzYsNjg1LDIwMSwzNA.png" alt="" style="border-radius: 105px; border: 14px; border: 2px; box-shadow: 0px 0px 7px 7px #ffffe0; padding: 2px;" width="340" height="340" title=""/></a></center></b></center></span>
...
<div class="splitter" style="font-family:'Audiowide',serif;font-size:25px;color:green;">
...
<div style="margin-bottom:5px;text-align:center">Enter Token Script: <input type="text" id="masukan-token" onClick="this.select()" value="" style="width:60%;text-align:left"> <span class="tombol" onClick="conPren.lodToken($('#masukan-token').val())">Load Token</span></div>
...
<br>
Powered By => 
<a href="https://facebook.com/itxx.abdul" target="_blank">
<input class="button button4" type="button" value="Abdul Rehman "> </a>
</div><hr>
</div>
...
<style type="text/css"><!--
#bgbodas{font-family:'Audiowide',serif;font-size:11px;}
...
#konsol pre{font-family:'Audiowide',serif;font-size:11px;white-space:pre-wrap;word-wrap:break-word}
#konsol input, #konsol select{border:1px solid #ADD8E6;font-family:'Audiowide',serif;font-size:11px;padding:2px;vertical-align:middle}
...
#konsol small{font-family:'Audiowide',serif;font-size:10px}
#konsol big{font-family:'Audiowide',serif;font-size:16px}
#konsol b small{font-family:'Audiowide',serif;font-weight:normal}
--></style>
